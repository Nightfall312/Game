...
/// <summary>Drunk character variant — lower speed cap, frozen rolling, velocity damping.</summary>
public class DrunkNetworkPlayer : NetworkPlayer
{
    ...
    /// <summary>Freezes sphere rolling and fixes joint oscillation at spawn.</summary>
